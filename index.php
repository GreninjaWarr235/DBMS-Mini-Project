...
<body>
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img width="100%" height="643px" src="https://wallpaperset.com/w/full/a/8/c/173787.jpg" class="d-block w-100" alt="Delhi Photo">
        <div class="carousel-caption d-none d-md-block">
          <h6>New Delhi</h6>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <img width="100%" height="643px" src="https://pondicherrytourism.co.in/images/places-to-visit/header/paradise-beach-puducherry-tourism-entry-fee-timings-holidays-reviews-header.jpg" class="d-block w-100" alt="Puducherry Photo">
        <div class="carousel-caption d-none d-md-block">
          <h6>Puducherry</h6>
        </div>
      </div>
  ...
  <div class="intro_container">
    <div><img class="intro_img" height="200px" width="300px" src="https://www.tajhotels.com/content/dam/tajhotels/in/en/themes/Beach_dining_theme.png/jcr:content/renditions/cq5dam.web.512.512.png" alt=""></div>
    <div class="text">
      <p>BEACH RETREATS</p>
    ...
    <div><img class="intro_img" height="200px" width="300px" src="https://www.tajhotels.com/content/dam/tajhotels/in/en/themes/hill_station_theme.png/jcr:content/renditions/cq5dam.web.512.512.png" alt=""></div>
    <div class="text">
      <p>HILL STATIONS</p>
    ...
    <div><img class="intro_img" height="200px" width="300px" src="https://www.tajhotels.com/content/dam/tajhotels/in/en/themes/royal_theme.png/jcr:content/renditions/cq5dam.web.512.512.png" alt=""></div>
    <div class="text">
      <p>URBAN GETAWAYS</p>
    ...
    <div><img class="intro_img" height="200px" width="300px" src="https://media.cntraveler.com/photos/5ca50d2b19fc3838ff1a31b0/master/w_4000,h_2667,c_limit/Hong-Kong-China_GettyImages-900611166.jpg" alt=""></div>
  </div>
  ...
  <div id="mainouterbranches">
    ...
    <div class="branchesouter">
      ...
      <a href="Rooms.php" target="_blank">
        <div class="branches">
          <div class="Upperblock">
            <img class="branchimg" src="https://examsdaily.in/wp-content/uploads/2018/12/new-delhi-240x300.jpg" alt="New Delhi">
          </div>
          <div class="lowerblock">
      ...
      <a href="Rooms.php" target="_blank">
        <div class="branches">
          <div class="Upperblock">
            <img class="branchimg" src="https://indiatajtours.com/wp-content/uploads/2019/02/IMG_2746-59c2327eedd26__880-240x300.jpg" alt="Agra">
          </div>
          <div class="lowerblock">
      ...
      <a href="Rooms.php" target="_blank">
        <div class="branches">
          <div class="Upperblock">
            <img class="branchimg" src="https://aquablissresort.com/wp-content/uploads/2019/07/pik36-240x300.jpg" alt="Kerala">
          </div>
          <div class="lowerblock">
  ...
  <main>
    ...
    <div class="image_container">
      <div>
        <img src="https://image.wedmegood.com/resized/800X/uploads/member/77182/1489015432_1468053919_taj4.jpg" height="250" width="350" />
      </div>
      <div>
        <img src="https://static2.tripoto.com/media/filter/tst/img/15546/TripDocument/1460134534_1_quan_spa_3_luxurylaunches.jpg" height="250" width="350" />
      </div>
      <div>
        <img src="https://content.jdmagicbox.com/comp/mumbai/j3/022pxx22.xx22.120109161138.y5j3/catalogue/gold-s-gym-powai-mumbai-gyms-dsf2hfd5ux.jpg?clr=3b2b2b" height="250" width="350" />
      </div>
      <div>
        <img src="https://www.tajhotels.com/content/dam/luxury/hotels/Taj_Mahal_Delhi/images/4x3/Varq-PrivateDiningRoom-Master.jpg/jcr:content/renditions/cq5dam.web.512.512.jpeg" height="250" width="350" />
      </div>
      <div>
        <img src="https://cf.bstatic.com/data/xphoto/1182x887/401/40108648.jpg?size=S" height="250" width="350" />
      </div>
      <div>
        <img src="https://media-cdn.tripadvisor.com/media/photo-s/09/3d/de/b7/city-the-village.jpg" height="250" width="350" />
      </div>
      <br>
    </div>
  </main>
